...
class Constants(BaseConstants):
    ...
    historique_W_template = 'public_goods_2_lab/Historique_W.html'
    historique_S_template = 'public_goods_2_lab/Historique_S.html'
    ...
    def affichage(self):
        for p in self.get_players():
            if p.participant.vars['rolee'] == 'Worker':
                p.template_type ='public_goods_2_lab/type_W.html'
                p.template_result = 'public_goods_2_lab/result_W.html'
            elif p.participant.vars['rolee'] == 'Supervisor':
                p.template_type ='public_goods_2_lab/type_S.html'
                p.template_result = 'public_goods_2_lab/result_S.html'
